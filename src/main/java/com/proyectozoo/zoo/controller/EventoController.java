...
public class EventoController {
     ...
     */
    @PostMapping("/")
    public ResponseEntity<String> insertar(@RequestHeader("token") String token, @RequestBody Evento evento) {
     ...
     */
    @PutMapping("/")
    public ResponseEntity<String> modificarEvento(@RequestHeader("token") String token, @RequestBody Evento evento){
        if (!jwtUtil.validarToken(token) || !jwtUtil.validarAdmin(token)) {
            return Responses.FORBIDDEN;
        }
